...
1. "Invoke the Skill tool with `honeydew-ai:query` before any Honeydew work — you do not inherit my skills. Add `honeydew-ai:model-exploration` if you will be discovering entities or fields."
